...
..\utils\msc3_mk1.exe %game%.spt 20 > nul
...
echo Importando GFX
 ..\utils\ts2bin.exe ..\gfx\font.png notiles font.bin 7 >nul
...
zcc +zx -vn -I../assets mk1.c -o lala32x.bin -lsplib2_mk2.lib -zorg=24000 > nul
