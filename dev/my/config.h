...
// MODE BIG SPRITES (16x32)
#define MODE_32X							// Use 16x32 Sprites instead of classic 16x16
	// Background collision
#define TOP_BG_COLLISION_NORMAL		8		// Top point for Bounding box, reduce (in pixels) the height of the collision box for background. eg: 8 means a 16x24 box instead of 16x32
	// Enemy collision
...
#define PLAYER_NUM_OBJETOS		(level_data.max_objs)		// Objects to get to finish game
...
// Bounding box size
// -----------------
											// Comment both for normal 16x16 bounding box (Recommended for MODE_32X)
...
#define LB_FRAMES 				8		// If defined, defines the # of frames bullets live (fixed)
...
#define BREAKABLE_WALLS_LIFE	5			// Amount of hits to break wall

#define BREAKABLE_WALLS_HIT_CHANGE          // Activar/desactivar el cambio de tile al golpear paredes rompibles
#define BREAKABLE_WALLS_HIT_TILE    28      // Tile que se muestra al golpear una pared rompible
...
#define	ONE_PUSH_ONE_JUMP					// If defined, player cannot keep pressed jump button to continuous jumping (only one jump per press)
...
#define PLAYER_MAX_VY_SALTANDO		576 	// Max jump velocity 
#define PLAYER_INCR_SALTO			64		// acceleration while JUMP is pressed 

#define PLAYER_INCR_JETPAC			80		// Vertical jetpac gauge
...
unsigned char behs [] = {
	0, 8, 8, 0, 0, 8, 8, 1, 8, 8, 8, 8, 24, 8,10,10,
